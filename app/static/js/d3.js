...
$(document).ready(function(){
  $('.easy-as-pie-chart').each(function(index){
    var answer_count = $(this).attr("data-answer");
    answer = answer_count;
    var w = 450;
    var h = 300;
    var r = 100;
    ...
    var vis = d3.select($('.easy-as-pie-chart')[index]).append("svg:svg")
      .attr("width", w)
      .attr("height", h)
    ...
    function update() {
      ...
      streakerDataAdded = d3.range(10).map(fillArray);
      // console.log(fillArray);
      // console.log(d3.range(10).map(fillArray));
      ...
      function filterData(element, index, array) {
        element.name = answer_count[index].port;
